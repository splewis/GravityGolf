...
class LevelFrame extends JFrame implements KeyListener {
	...
	public void keyPressed(KeyEvent event) {
		...
		switch(key) {
			case KeyEvent.VK_R: lp.reset();   break;
			case KeyEvent.VK_UP:    lp.dy += 100;   break;
			case KeyEvent.VK_DOWN:  lp.dy -= 100;   break;
			case KeyEvent.VK_RIGHT: lp.dx -= 100;   break;
			case KeyEvent.VK_LEFT:  lp.dx += 100;   break;
		}
	}
